...
import { AcceptSolicitationAction } from "@repo/services/solicitationsAction";
...
export function AcceptSolicitationModal({
  isOpen,
  onClose,
  solicitation,
  ...
  const handleConfirmAccept = async () => {
    setLoading(true);
    try {
      const res = await AcceptSolicitationAction(solicitation.id);
  ...
  return (
    ...
    ">
      ...
      ">  
        ...
        ">
          <p>
            Você tem certeza que deseja aceitar a solicitação de tutoria?
          </p>
        </div>
